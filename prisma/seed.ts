...
async function main() {
    ...
    console.log("Seeding mahasiswa per program studi...");
    ...
    // 8. Seed 50 Letter Instance (Surat Rekomendasi Beasiswa) untuk Mahasiswa Budi
    console.log("Seeding 50 Letter Instances...");
    ...
    console.log(
        "✅ 50 Letter Instances seeded successfully for Budi Mahasiswa",
    );
