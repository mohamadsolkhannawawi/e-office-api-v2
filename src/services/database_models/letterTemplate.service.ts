...
>(Prisma.letterTemplate) {
  // biome-ignore lint/suspicious/noExplicitAny: penggunaan any disengaja untuk keperluan validasi skema
  ...
  public static async create(data: LetterTemplateUncheckedCreateInput) {
    // Validasi agar nama versi unik dalam satu jenis surat.
    ...
    // Skema harus sesuai dengan versi skema yang digunakan.
